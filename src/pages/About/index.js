  ...
  return (
    <Container>
      ...
      <ContentBlock
        ...
        title={'Vision'}
        content={
          'BitBadges intends to be a completely open source and community driven project. BitBadges creator coins will be given out to those who help maintain the ecosystem and innovate upon it. Join the discord at discord.gg/TJMaEd9bar'
        }
